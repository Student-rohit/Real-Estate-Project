...
export const updateUser = async (req, res, next) => {
  ...
  try {
    ...
    if (req.body.avatar) {
      ...
      if (user.avatar && user.avatar !== req.body.avatar && !user.avatar.includes('cdn.pixabay.com')) {
...
export const deleteUser = async (req, res, next) => {
  ...
  try {
    ...
    // Delete user avatar from Firebase
    if (user.avatar && !user.avatar.includes('cdn.pixabay.com')) {
      await deleteFileFromCloudinary(user.avatar);
    }

    // Delete all user listings and their images from Firebase
